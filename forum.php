...
<div class="d-flex">
    ...
    <div class="sidebar d-flex flex-column flex-shrink-0 bg-body-tertiary" style="width: 5.7rem;">
        ...
        <div class="container d-flex flex-column justify-content-center">
            <div class="row">
                <div class="col-lg-8 mx-auto my-3 p-2 bg-body rounded shadow-sm">
                    <h6 class="border-bottom pb-2 mb-0 text-center">Publications les plus récentes</h6>
                    <div class="d-flex text-body-secondary pt-3 mx-auto">
                    ...
                    <small class="d-block text-end mt-3">
                        <a href="#">Toutes les publications</a>
                    </small>
                </div>
            </div>
        </div>
