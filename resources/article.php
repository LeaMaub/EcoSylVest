...
<div class="container my-5">
    <div class="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg">
        <div class="col-lg-7 p-3 p-lg-6 pt-lg-2">
            <h1 class="display-5 fw-bold "><?= htmlentities($article['title'])?></h1>
            <h1 class="display-6 fw-bold mb-5"><?= htmlentities($article['subtitle'])?></h1>
